    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                ...
                style="font-size: 2.5rem; font-weight: 700; color: white; text-align: center; margin-bottom: 30px;">Indices</h2>
            </div>
            <!-- end section title -->
            ...
            <div class="col-12">
                ...
                <div class="about__text" style="max-width: 800px; margin: 0 auto; color: rgba(255,255,255,0.9);" data-aos="fade-up" data-aos-duration="3000">
                    <p style="font-size: 1.1rem; line-height: 1.7;">
                       Gain exposure to top-performing indices and diversify your portfolio with key financial markets right at your fingertips.
                    </p>
                </div>
                <!-- end about text -->
            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <h1 class="mb-4" style="font-weight: 700; color: #1a2980;">Indices CFD's</h1>
                <p class="lead mb-4" style="line-height: 1.6; color: #555;">Access global indices CFD's on our platform, allowing you to trade major market benchmarks from around the world. Gain exposure to leading indices and diversify your trading portfolio with key financial markets at your fingertips.</p>
                <h5 class="mb-3" style="color: #1a2980;">Trade with Major Indices CFD's:</h5>
                <div class="d-flex flex-wrap index-buttons">
                    <button type="button" class="btn breathing transition-all" id="button-sandp">S&P 500</button>
                    <button type="button" class="btn breathing transition-all" id="button-honkong">Hong Kong (HK50)</button>
                    <button type="button" class="btn breathing transition-all" id="button-firstGer30">GER30</button>
                    <button type="button" class="btn breathing transition-all" id="button-secondGer30">AU200</button>
                    <button type="button" class="btn breathing transition-all" id="button-dowJones">Dow Jones</button>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-6 col-md-4 mb-4 text-center">
                        <img src="{{ asset('') }}images/symbol/27.png" alt="S&P 500" id="image-sandp" class="index-image transition-all">
                    </div>
                    <div class="col-6 col-md-4 mb-4 text-center">
                        <img src="{{ asset('') }}images/symbol/26.png" alt="Hong Kong" id="image-honkong" class="index-image transition-all">
                    </div>
                    <div class="col-6 col-md-4 mb-4 text-center">
                        <img src="{{ asset('') }}images/symbol/24.png" alt="GER30" id="image-firstGer30" class="index-image transition-all">
                    </div>
                    <div class="col-6 col-md-4 mb-4 text-center">
                        <img src="{{ asset('') }}images/symbol/25.png" alt="AU200" id="image-secondGer30" class="index-image transition-all">
                    </div>
                    <div class="col-6 col-md-4 mb-4 text-center">
                        <img src="{{ asset('') }}images/symbol/23.png" alt="Dow Jones" id="image-dowJones" class="index-image transition-all">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    // Enhanced hover effects for index buttons with smoother transitions
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.index-image').forEach(img => {
