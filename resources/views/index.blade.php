...
<div class="invest-section">
  <div class="container">
    ...
    <div class="invest-listing">
      <ul>
        <li>
          <a class="apple" href="#"><img src="{{ asset('') }}images/company-icon1.svg" alt="img" />$AAPL</a>
        </li>
        <li>
          <a class="nasdaq" href="#"><img src="{{ asset('') }}images/company-icon2.svg" alt="img" />NASDAQ</a>
        </li>
        <li>
          <a class="btc" href="#"><img src="{{ asset('') }}images/company-icon3.svg" alt="img" />BTC/USD</a>
        </li>
        <li>
          <a class="usoil" href="#"><img src="{{ asset('') }}images/company-icon4.svg" alt="img" />USOIL</a>
        </li>
        <li>
          <a class="euro" href="#"><img src="{{ asset('') }}images/company-icon5.svg" alt="img" />EUR/USD</a>
        </li>
        <li>
          <a class="xau" href="#"><img src="{{ asset('') }}images/company-icon6.svg" alt="img" />XAU/USD</a>
        </li>
      </ul>
    ...
    <div class="invest-condition">
      <ul>
        <li>
          <a href="#"><img src="{{ asset('') }}images/blue-tick-icon.svg" alt="img" />Transparent
            trading conditions</a>
        </li>
        <li>
          <a href="#"><img src="{{ asset('') }}images/blue-tick-icon.svg" alt="img" />Free
            Educational Materials</a>
        </li>
        <li>
          <a href="#"><img src="{{ asset('') }}images/blue-tick-icon.svg" alt="img" />Zero deposit
            fees</a>
        </li>
      </ul>
    </div>
  ...
  <div class="platform-section">
    <div class="platform-left">
      ...
      <div class="platform-btn">
        <a
          class="btn fillbtn"
          href="https://cp.theprimelimited.com/login">Create account</a>
        <a
          class="btn borderbtn"
          href="https://cp.theprimelimited.com/login">Sign-in</a>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="get-started">
      ...
      <ul>
        ...
        <li>
          <div class="startbox">
            <a href="https://cp.theprimelimited.com/login"><strong>Start trading</strong></a>
          </div>
        </li>
      </ul>
    </div>
